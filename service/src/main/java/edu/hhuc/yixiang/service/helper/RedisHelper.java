...
public class RedisHelper {
    ...
    public static boolean releaseLock(String key, String value) {
        Long result = (Long) redisTemplate.execute(LuaScriptFactory.getScript(ScriptEnum.DISTRIBUTED_LOCK_RELEASE_SCRIPT), Collections.singletonList(key), value);
        return Objects.equals(1L, result);
    }

    public static <T> T executeScrpit(RedisScript<T> script, List<String> keys, Object... args) {
